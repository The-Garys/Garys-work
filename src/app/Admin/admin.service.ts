...
public updateImageandService(image,profession,id){
  return this.httpClient.put(`http://localhost:3000/api/professions/updateImageandServices/${id}`,{image,profession})
}
}
